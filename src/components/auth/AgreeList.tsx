...
const AgreeList = () => {
  return (
    <div>
      ...
      <div>
        <span className='text-gray-900 text-body_sm'>2. 개인정보 수집 및 이용 목적</span> <br />
        <span className='text-gray-900 text-body_sm'>수집한 개인정보는 다음 목적을 위해 사용됩니다</span> <br />
        <span className='text-gray-700 text-label_sm'>- 회원가입 의사 확인 및 회원 식별</span>
      </div>
      <br />
      <div>
        <span className='text-gray-900 text-body_sm'>3. 개인정보 보유 및 이용 기간</span> <br />
        <span className='text-gray-900 text-body_sm'>
      ...
      <div>
        ...
        <span className='text-gray-900 text-body_sm'>
          원칙적으로, 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 전자적 파일 형태의
          정보는 기록을 재생할 수 없느니술적 방법을 사용하여 삭제합니다. 종이에 출력된 정보는 분쇄기로 분쇄하거나 속하여
          파기합니다.
        </span>
      </div>
    </div>
